# RailsAdmin config file. Generated on October 25, 2012 13:48
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Rrhw3', 'Admin']
  ...
  # config.excluded_models = ['Friend', 'Order', 'Review']

  # Include specific models (exclude the others):
  # config.included_models = ['Friend', 'Order', 'Review']
  ...
  #     configure :id, :integer 
  #     configure :restaurant, :string 
  #     configure :opinion, :text 
  #     configure :created_at, :datetime 
  #     configure :updated_at, :datetime 
  #     configure :YesNo, :string 
